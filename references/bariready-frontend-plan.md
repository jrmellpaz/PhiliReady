...
function MapSkeleton() {
  return (
    <div
      className="h-full w-full bg-[#0F2040] flex items-center
          ...
          return (
            <div key={key} className="mb-2">
              <div className="flex justify-between mb-1">
                <span className="text-[10px] font-mono text-[#E8EDF4]">
                  {label}
                </span>
              ...
              <div className="h-0.75 bg-[#1E3A5F] rounded-full overflow-hidden">
                <div
                  style={{
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-1">
        <h2 className="text-sm font-semibold text-[#E8EDF4] leading-tight">
          {name}
        </h2>
        <button
          onClick={onClose}
...
function Stat({
  ...
  return (
    ...
    >
      <p className="text-[9px] text-[#6B7F99] font-mono mb-1 tracking-widest uppercase">
        {label}
      </p>
